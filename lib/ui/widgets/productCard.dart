...
import 'package:prueba1/ui/views/products/productDetails.dart';
...
class InventoryCard extends StatelessWidget {
  final Inventory inventoryDetails;

  InventoryCard({@required this.inventoryDetails});

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (_) => InventoryDetails(product: inventoryDetails)));
      },
      child: Padding(
        padding: EdgeInsets.all(8),
        child: Card(
          ...
          child: Container(
            ...
            child: Column(
              children: <Widget>[
                Hero(
                  tag: inventoryDetails.id,
                  child: Image.asset(
                    'assets/${inventoryDetails.img}.jpg',
                    height: MediaQuery
                        .of(context)
                        .size
                        .height *
